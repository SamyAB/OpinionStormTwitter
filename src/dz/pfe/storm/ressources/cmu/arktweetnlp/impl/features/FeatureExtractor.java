...
public class FeatureExtractor {
	...
	public Logger log = Logger.getLogger("FeatureExtractor");
	...
	public class PositionFeaturePairs {
	...
	private void initializeFeatureExtractors() throws IOException {
		...
		allFeatureExtractors.add(new WordListFeatures().getNewPOSTagDict());
		allFeatureExtractors.add(new WordListFeatures().getNewMetaphonePOSDict());

		allFeatureExtractors.add(new MiscFeatures().getNewNgramSuffix(20));
		allFeatureExtractors.add(new MiscFeatures().getNewNgramPrefix(20));
		allFeatureExtractors.add(new MiscFeatures().getNewPrevWord());
		allFeatureExtractors.add(new MiscFeatures().getNewNextWord());
		allFeatureExtractors.add(new MiscFeatures().getNewWordformFeatures());

		allFeatureExtractors.add(new MiscFeatures().getNewCapitalizationFeatures());
		allFeatureExtractors.add(new MiscFeatures().getNewSimpleOrthFeatures());
		allFeatureExtractors.add(new MiscFeatures().getNewPrevNext());

		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("proper_names"));
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("celebs")); //2012-08-09 version of freebase celebrity list
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("videogame")); //june 22 version of freebase video game list
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("mobyplaces"));	//moby dictionary of US locations
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("family"));
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("male"));
		allFeatureExtractors.add(new WordListFeatures().getNewListofnames("female"));

		allFeatureExtractors.add(new MiscFeatures().getNewPositions());
