package dz.pfe.storm.ressources.cmu.arktweetnlp.io;
...
public class CoNLLReader {
	public ArrayList<Sentence> readFile(String filename) throws IOException {
		BasicFileIO bfIO = new BasicFileIO();
		BufferedReader reader = bfIO.openFileToReadUTF8(filename);
...
//	}
	...
	private Sentence sentenceFromLines(List<String> lines) {
