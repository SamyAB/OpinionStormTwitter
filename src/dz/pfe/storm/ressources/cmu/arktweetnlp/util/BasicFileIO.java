package dz.pfe.storm.ressources.cmu.arktweetnlp.util;
...
public class BasicFileIO {
     ...
     */
    private Logger log = Logger.getLogger(BasicFileIO.class.getCanonicalName());

    public BufferedReader openFileToRead(String file) {
        try {
    ...
    public BufferedReader openFileToReadUTF8(String file) {
        try {
            BufferedReader bReader = null;
            if (file.endsWith(".gz")) {
                bReader = new BufferedReader(new InputStreamReader(
    ...
    public BufferedWriter openFileToWrite(String file) {
        try {
    ...
    public BufferedWriter openFileToWriteUTF8(String file) {
        try {
            BufferedWriter bWriter = null;
            if (file.endsWith(".gz")) {
                bWriter = new BufferedWriter(new OutputStreamWriter(
    ...
    public void closeFileAlreadyRead(BufferedReader bReader) {
        try {
            bReader.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void closeFileAlreadyWritten(BufferedWriter bWriter) {
        try {
            bWriter.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String getLine(BufferedReader bReader) {
        try {
    ...
    public String getLine(JsonParser jParse) {
    ...
    public void writeLine(BufferedWriter bWriter, String line) {
        try {
            bWriter.write(line + "\n");
        } catch(IOException e) {
            e.printStackTrace();
    ...
    public void writeSerializedObject(String file, Object object) {
        try{
    ...
    public Object readSerializedObject(String file) {
        try {
    ...
    public Object readSerializedObject(InputStream iFile) {
        Object object = null;
        try{
	 ...
	 * @throws IOException
	 */
	public BufferedReader getResourceReader(String resourceName) throws IOException {
	 ...
	 * @throws IOException **/
	public BufferedReader openFileOrResource(String fileOrResource) throws IOException {
		try {
